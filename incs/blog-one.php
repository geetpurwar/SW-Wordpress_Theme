<?php if(get_field('select_blogpost')): ?>
<?php $postId = get_field('select_blogpost'); ?>
<section class="blogposts onePost">
    <div class="container">
        <div class="gridBloglistContainer">
            ...
            while ( $loop->have_posts() ) : $loop->the_post(); ?>
                <div class="gridBloglist fullWidth">
                    <article class="gridPost">
                        <?php if(get_field('article_featured_image', $postId)): ?>
                        <a href="<?php the_permalink(); ?>" class="postThumbnailLink">
                            <?php
                            $attachment_id = get_field('article_featured_image', $postId)['id'];
