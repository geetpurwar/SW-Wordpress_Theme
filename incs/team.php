<section class="dualHeadings <?php if(is_page_template('page-about.php')): ?>about-page-top<?php endif; ?> teamTopSection <?php echo get_field('team_top_background_color'); ?>">
    <div class="container">
        <?php if(get_field('about_top_title') || get_field('about_top_subtitle') || get_field('about_top_content')): ?>
        <div class="sectionTop">
            <?php if(get_field('about_top_title')): ?>
            <h2 class="topTitle"><?php echo get_field('about_top_title'); ?></h2>
            <?php endif; ?>

            <?php if(get_field('about_top_subtitle')): ?>
            <h3 class="topSubtitle"><?php echo get_field('about_top_subtitle'); ?></h3>
            <?php endif; ?>

            <?php if(get_field('about_top_content')): ?>
            <p class="topContent"><?php echo get_field('about_top_content'); ?></p>
            <?php endif; ?>
        </div>
        <?php endif; ?>

        <?php if(get_field('about_bottom_title')): ?>
            <h2 class="sectionTitle"><?php echo get_field('about_bottom_title'); ?></h2>
        <?php else: ?>
...
<section class="dualHeadings teamBottomSection <?php echo get_field('team_bottom_background_color'); ?>">
    <div class="container">
        <div class="subSection">
            ...
            <div class="md:hidden">
                <div class="dualColumn2">
                    <?php if( have_rows('team_bottom_left_columns', 'option') ): ?>
                    <?php while( have_rows('team_bottom_left_columns', 'option') ) : the_row(); ?>
                        <div class="pb-8">
                            <?php if(get_sub_field('title')): ?>
                            <h3 class="h3 mb-4"><?php echo get_sub_field('title'); ?></h3>
                            <?php endif; ?>
                            
                            <div class="body2light">
                            <?php echo $vari = apply_filters('the_content', get_sub_field('content')); ?>
                            </div>
                        </div>
                    <?php endwhile; ?>
                    ...
                    <?php while( have_rows('team_bottom_right_columns', 'option') ) : the_row(); ?>
                        <div class="pb-8">
                            ...
                            <div class="body2light flex flex-col space-y-4">
                            <?php echo $vari = apply_filters('the_content', get_sub_field('content')); ?>
                            </div>
                        </div>
                    <?php endwhile; ?>
