<section class="dualColumnSquareImage <?php echo get_field('dcsi1_background_color'); ?>">
    <div class="container">
        <div class="sectionTopBottom">
            <div class="sectionSubTop">
                <?php if(get_field('dcsi1_section_title')): ?>
                <h2 class="sectionTitle"><?php echo get_field('dcsi1_section_title'); ?></h2>
                <?php endif; ?>

                <?php if(get_field('dcsi1_tags')): ?>
                <?php $tags = get_field('dcsi1_tags'); ?>
            ...
            <?php if( have_rows('dcsi1_column') ): ?>
            <div class="dualColumnSquares">
                <?php while( have_rows('dcsi1_column') ) : the_row(); ?>
                <div class="column">
            ...
            <?php if(get_field('dcsi1_button_link_internal') || get_field('dcsi1_button_link_external')): ?>
                <div class="buttonLine">
                    <?php if(get_field('dcsi1_button_link_internal')): ?>
                        <a href="<?php echo get_permalink(get_field('dcsi1_button_link_internal')); ?>" class="button"><?php echo get_field('dcsi1_button_title'); ?></a>
                    <?php else: ?>
                        <?php if(get_field('dcsi1_button_link_external')): ?>
                            <a href="<?php echo get_field('dcsi1_button_link_external'); ?>" class="button"><?php echo get_field('dcsi1_button_title'); ?></a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
